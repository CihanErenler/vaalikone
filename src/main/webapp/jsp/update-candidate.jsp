  ...
  <body>
    ...
    <div class="add-can container flex-container">
      <div class="card">
        ...
        <div class="add-img">
            <img class="output-img" src="../img/${requestScope.profile.profile_pic}" alt="candidate" />
        </div>
            <form action="update?id=${requestScope.profile.id}" method="POST" enctype="multipart/form-data" class="candidate-form">
                <label for="img-file" class="upload"></i>Add Picture</label>
                <input type="file" name="file" id="img-file" value="">	
                ...
                <input type="text" name="party" id="party" placeholder="Political party" value="${requestScope.profile.political_party}"/>
                <textarea name="whycan" id="" placeholder="Why did you become a candidate?">${requestScope.profile.why_candidate}</textarea>
